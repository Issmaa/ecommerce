...
export const StateContext = ({children}) => {
    ...
    const onAdd = (product, quantity) => {
        ...
        setTotalPrice((prevTotalPrice) => Math.round(prevTotalPrice + product.price * quantity))
    ...
    const onRemove = (product) => {
        ...
        setTotalPrice((previousTotalPrice) => Math.round(previousTotalPrice - foundProduct.price * foundProduct.quantity));
